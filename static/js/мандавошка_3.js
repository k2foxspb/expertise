...
let w = document.getElementById('creature').offsetWidth;
let h = document.getElementById('creature').offsetHeight;
let buffer
let canvas
let creature
let bubbles
...
class Creature extends Chain {
    ...
    updateTarget() {
        ...
        if (
            this.position[0] > w + 500 ||
            this.position[0] < -500 ||
            this.position[1] > h + 500 ||
            this.position[1] < -500
        ) {
